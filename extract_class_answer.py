...
BASE_PROMPT = "An elderly user will ask you a question, and you should answer" + \
...
EXAMPLES = "If there is no object to find or if the object to find does not " + \
            ...
            "Assistant: {'answer': 'Sure, let me find your keys. Wait a second.', " + \
                        "'object_class_to_find': 'CUP'}\n" + \
            "Here in the user question.\n"

DEFAULT_DICT_OUTPUT = {'answer': 'I am sorry, but I did not understand your question... Could you please refrain it?', 'class': ''}
